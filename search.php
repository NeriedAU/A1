...
<html lang="en">
	...
	<head>
		...
		<title>Wine Store - Search for wine online</title>		
				...
				<div class="form-group">
					...
					<select class="form-control" name="wineRegion" id="searchSelectRegion">
						...
						<?php
							...
							//Loop through each region_name returned from the query and add it as an option in the select box.
				...
				<div class="form-group">		
					...
					<select class="form-control" name="grapeVariety" id="searchSelectGrapeVariety">
						...
						<?php
							...
							//Loop through each variety returned from the query and add it as an option in the select box.
